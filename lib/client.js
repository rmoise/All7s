...
const sanityToken = process.env.NEXT_STAGING_SANITY_TOKEN || process.env.NEXT_PUBLIC_SANITY_TOKEN;
const sanityDataset = process.env.NEXT_STAGING_SANITY_DATASET || process.env.NEXT_PUBLIC_SANITY_DATASET;
