...
const Newsletter: React.FC<NewsletterProps> = ({ newsletter }) => {
  return (
    <section className="relative w-full z-10 overflow-hidden py-8 bg-black" id="newsletter">
        ...
        <div className="mx-auto max-w-7xl py-8 px-6 sm:px-8 md:px-12 lg:px-24 xl:px-16">
          ...
          <div className="lg:flex lg:items-start lg:justify-between">
            ...
            <div className="lg:w-1/2 lg:text-left">
              <h2
                className="text-2xl sm:text-3xl lg:text-4xl font-bold font-Headline tracking-tight text-white mb-4"
            ...
            <div className="mt-8 lg:mt-0 lg:w-auto lg:flex lg:items-center lg:ml-auto">
              <form
                name="newsletter"
                method="POST"
                className="w-full sm:w-full lg:w-auto lg:flex lg:items-center"
                data-netlify="true"
              >
